...
const policyKeys=['foodBuffer','childFoodBuffer','gardenCapacity','foodExpansionSatiety','farmThreshold','marketThreshold','clinicThreshold','maternityThreshold','maternityLeadDays','medicalTrainingThreshold','parkThreshold','housingThreshold','familyPriorityAge','birthTarget','comfortReserve','familyCashReserve','sellRatio','mayorRotationCycles'];

function validPolicy(policy){return policy&&policy.version===1&&policy.trainingVersion===8&&policy.best&&policy.best.genome&&policyKeys.every(key=>Number.isFinite(policy.best.genome[key]))}
