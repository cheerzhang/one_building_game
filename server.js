...
function validPolicy(policy){return policy&&policy.version===1&&policy.trainingVersion===18&&policy.best&&policy.best.genome&&policyKeys.every(key=>Number.isFinite(policy.best.genome[key]))}
