...
const policyKeys=['foodBuffer','gardenCapacity','farmThreshold','marketThreshold','clinicThreshold','maternityThreshold','housingThreshold','birthTarget','comfortReserve','sellRatio'];
